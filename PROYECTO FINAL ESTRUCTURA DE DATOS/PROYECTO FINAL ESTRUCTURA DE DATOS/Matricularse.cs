...
{
    public partial class Matricularse : Form
    {
        //Listas-------------------------------------------------------
        ...
        //-------------------------------------------------------------
        public Matricularse(List<string> u_Administradores, List<string> C_Administradores,
        ...
        private void Matricularse_FormClosing(object sender, FormClosingEventArgs e)
        {
           
        }

        private void Matricularse_Load(object sender, EventArgs e)
        {

        }

        private void Matricularse_FormClosed(object sender, FormClosedEventArgs e)
        {
