...
namespace PROYECTO_FINAL_ESTRUCTURA_DE_DATOS
{
    public partial class Estudiantes : Form
    {
        ...
        //-------------------------------------------------------------
        public Estudiantes(List<string> u_Administradores, List<string> C_Administradores,
        ...
        private void Estudiantes_FormClosing(object sender, FormClosingEventArgs e)
        {
