...
namespace Colegio {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class AdminsDataTable : global::System.Data.TypedTableBase<AdminsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AdminsRow AddAdminsRow(string Users, string Passwords) {
            ...
            private void InitClass() {
                ...
                this.columnUsers.MaxLength = 150;
                this.columnPasswords.AllowDBNull = false;
                this.columnPasswords.MaxLength = 150;
            }
        ...
        public partial class AdminsRow : global::System.Data.DataRow {
            ...
            public string Users {
                get {
                    return ((string)(this[this.tableAdmins.UsersColumn]));
                }
                set {
                    this[this.tableAdmins.UsersColumn] = value;
                }
            }
...
namespace Colegio.Database1DataSetTableAdapters {
    ...
    public partial class AdminsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Admins] WHERE (([Id] = @Original_Id) AND ([Users] = @Original_" +
                "Users) AND ([Passwords] = @Original_Passwords))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Admins] ([Users], [Passwords]) VALUES (@Users, @Passwords);\r\nS" +
                "ELECT Id, Users, Passwords FROM Admins WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Admins] SET [Users] = @Users, [Passwords] = @Passwords WHERE (([Id]" +
                " = @Original_Id) AND ([Users] = @Original_Users) AND ([Passwords] = @Original_Pa" +
                "sswords));\r\nSELECT Id, Users, Passwords FROM Admins WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Colegio.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Users, Passwords FROM dbo.Admins";
        ...
        public virtual int Fill(Database1DataSet.AdminsDataTable dataTable) {
        ...
        public virtual Database1DataSet.AdminsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.AdminsDataTable dataTable = new Database1DataSet.AdminsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.AdminsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Users, string Original_Passwords) {
        ...
        public virtual int Insert(string Users, string Passwords) {
            if ((Users == null)) {
        ...
        public virtual int Update(string Users, string Passwords, int Original_Id, string Original_Users, string Original_Passwords, int Id) {
            if ((Users == null)) {
                throw new global::System.ArgumentNullException("Users");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Users, string Passwords, int Original_Id, string Original_Users, string Original_Passwords) {
            return this.Update(Users, Passwords, Original_Id, Original_Users, Original_Passwords, Original_Id);
        }
    }
