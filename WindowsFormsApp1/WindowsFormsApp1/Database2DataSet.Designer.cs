...
namespace WindowsFormsApp1 {
    ...
    public partial class Database2DataSet : global::System.Data.DataSet {
        ...
        public partial class AdminsDataTable : global::System.Data.TypedTableBase<AdminsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AdminsRow AddAdminsRow(string User) {
...
namespace WindowsFormsApp1.Database2DataSetTableAdapters {
    ...
    public partial class AdminsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Admins] WHERE (([Id] = @Original_Id) AND ([User] = @Original_U" +
                "ser))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Admins] ([User]) VALUES (@User);\r\nSELECT Id, [User] FROM Admin" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Admins] SET [User] = @User WHERE (([Id] = @Original_Id) AND ([User]" +
                " = @Original_User));\r\nSELECT Id, [User] FROM Admins WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp1.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [User] FROM dbo.Admins";
        ...
        public virtual int Fill(Database2DataSet.AdminsDataTable dataTable) {
        ...
        public virtual Database2DataSet.AdminsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database2DataSet.AdminsDataTable dataTable = new Database2DataSet.AdminsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database2DataSet.AdminsDataTable dataTable) {
        ...
        public virtual int Update(string User, int Original_Id, string Original_User, int Id) {
            if ((User == null)) {
                throw new global::System.ArgumentNullException("User");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string User, int Original_Id, string Original_User) {
            return this.Update(User, Original_Id, Original_User, Original_Id);
        }
    }
